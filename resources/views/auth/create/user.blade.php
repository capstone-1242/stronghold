<x-admin-layout>
    ...
    <form method="POST" action="{{ route('register.store') }}">
        ...
        <div class="mb-6">
            ...
            <input type="text" id="first_name" name="first_name" value="{{ old('first_name') }}" class="border border-gray-800 p-2 w-full rounded-xl" required>
            <small>Enter the users first name.</small>
        </div>

        <div class="mb-6">
            <label for="last_name" class="block w-full">Last Name</label>
            <input type="text" id="last_name" name="last_name" value="{{ old('last_name') }}" class="border border-gray-800 p-2 w-full rounded-xl" required>
        ...
        <div class="mb-6">
            ...
            <input type="email" id="email" name="email" value="{{ old('email') }}" class="border border-gray-800 p-2 w-full rounded-xl" required>
            <small>Provide a valid email address.</small>
        </div>

        <div class="mb-6">
            <label for="password" class="block w-full">Password</label>
            <input type="password" id="password" name="password" class="border border-gray-800 p-2 w-full rounded-xl" required autocomplete="new-password">
        ...
        <div class="mb-6">
            ...
            <input type="password" id="password_confirmation" name="password_confirmation" class="border border-gray-800 p-2 w-full rounded-xl" required>
