<x-admin-layout :title="'Create a User'">
   <section class="p-6 md:p-12 container">
        ...
        <form method="POST" action="{{ route('register.store') }}">
            ...
            <div class="mb-6">
                <input type="submit" value="Register User" class="cursor-pointer bg-sky-900 text-white p-2 rounded-xl hover:bg-sky-600 w-full">
            </div>
        </form>
