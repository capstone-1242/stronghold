...
<x-admin-layout :title="'Create a Testimonial'">
    <section class="p-6 md:p-12 container">
        ...
        <form action="{{ route('auth.create.testimonial') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="url" id="url" name="url" value="{{ old('url') }}" class="border border-gray-800 p-2 w-full rounded-xl bg-white" required>
            ...
            <div class="mb-6">
                <input type="submit" value="Add Testimonial" class="cursor-pointer bg-sky-900 text-white p-2 rounded-xl hover:bg-sky-600 w-full">
            </div>
        </form>
