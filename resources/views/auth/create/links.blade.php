<x-admin-layout>
    ...
    <form action="{{ route('links.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <select name="author_id" id="author_id" class="border border-gray-800 p-2 w-full rounded-xl" required>
        ...
        <div class="mb-4">
            ...
            <input type="url" name="url" id="url" class="border border-gray-800 p-2 w-full rounded-xl" required value="{{ old('url') }}">
            <small>Please enter a valid URL.</small>
        </div>
        
        <div class="mb-4">
            <label for="title" class="block w-full">Title</label>
            <input type="text" name="title" id="title" class="border border-gray-800 p-2 w-full rounded-xl" required value="{{ old('title') }}">
