<x-admin-layout>
    ...
    <form action="{{ route('memorial.store') }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <textarea name="biography" id="biography" class="border border-gray-800 p-2 w-full rounded-xl" required>{{ old('biography') }}</textarea>
        ...
        <div class="mb-6">
            ...
            <input type="number" name="birth_year" id="birth_year" class="border border-gray-800 p-2 w-full rounded-xl" value="{{ old('birth_year') }}">
        ...
        <div class="mb-6">
            ...
            <input type="number" name="death_year" id="death_year" class="border border-gray-800 p-2 w-full rounded-xl" value="{{ old('death_year') }}">
        ...
        <div class="mb-6">
            ...
            <select name="tag_id" id="tag_id" class="border border-gray-800 p-2 w-full rounded-xl">
