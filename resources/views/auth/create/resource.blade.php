<x-admin-layout>
    ...
    <form action="{{ route('resource.store') }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <textarea id="description" name="description" class="border border-gray-800 p-2 w-full rounded-xl">{{ old('description') }}</textarea>
            <small>Provide a short description of the resource.</small>
        </div>

        <div class="mb-6">
            <label for="url" class="block w-full">URL</label>
            <input type="url" id="url" name="url" value="{{ old('url') }}" class="border border-gray-800 p-2 w-full rounded-xl">
        ...
        <div class="mb-6">
            ...
            <input type="text" id="number" name="number" value="{{ old('number') }}" class="border border-gray-800 p-2 w-full rounded-xl">
