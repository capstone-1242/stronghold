<x-admin-layout>
    <section class="p-6 md:p-12">
        ...
        <div class="flex flex-wrap justify-evenly my-12 gap-6">
            ...
            <a href="{{ route('auth.edit.memorial') }}" class="p-6 border-2 border-blue-400 bg-blue-200 flex items-center gap-2 rounded-xl">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8">
            ...
            <a href="{{ route('auth.destroy.memorial') }}" class="p-6 border-2 border-red-400 flex items-center gap-2 rounded-xl bg-red-200">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8">
