<x-admin-layout>
    ...
    <form method="GET" action="{{ route('auth.edit.memorial') }}" class="mb-6">
        ...
        <select id="select-memorial" name="memorial_id" class="border border-gray-800 p-2 w-full rounded-xl" onchange="this.form.submit()">
    ...
    @if ($memorial)
        <form action="{{ route('memorial.update', $memorial->id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="first_name" name="first_name" class="border border-gray-800 p-2 w-full rounded-xl" value="{{ old('first_name', $memorial->first_name) }}" required>
            ...
            <div class="mb-6">
                ...
                <input type="text" id="last_name" name="last_name" class="border border-gray-800 p-2 w-full rounded-xl" value="{{ old('last_name', $memorial->last_name) }}" required>
            ...
            <div class="mb-6">
                ...
                <textarea id="biography" name="biography" class="border border-gray-800 p-2 w-full rounded-xl" required>{{ old('biography', $memorial->biography) }}</textarea>
            ...
            <div class="mb-6">
                ...
                <input type="number" id="birth_year" name="birth_year" class="border border-gray-800 p-2 w-full rounded-xl" value="{{ old('birth_year', $memorial->birth_year) }}">
            ...
            <div class="mb-6">
                ...
                <input type="number" id="death_year" name="death_year" class="border border-gray-800 p-2 w-full rounded-xl" value="{{ old('death_year', $memorial->death_year) }}">
            ...
            <div>
                <input type="submit" value="Update Memorial" class="bg-sky-900 text-white p-2 rounded-xl hover:bg-sky-600 w-full">
            </div>
        </form>
    @endif
