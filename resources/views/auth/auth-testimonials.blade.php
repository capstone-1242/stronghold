<x-admin-layout :title="'Testimonials'">
   <section class="p-6 md:p-12">
        ...
        <div class="flex flex-wrap justify-evenly my-18 gap-6">
            <a href="{{ route('auth.create.testimonial') }}" class="p-6 border-2 border-yellow-400 bg-yellow-200 flex items-center gap-2 rounded-xl hover:bg-yellow-400 transition-colors duration-300">
            ...
            <a href="{{ route('auth.edit.testimonial') }}" class="p-6 border-2 border-blue-400 bg-blue-200 flex items-center gap-2 rounded-xl hover:bg-blue-400 transition-colors duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8">
            ...
            <a href="{{ route('auth.destroy.testimonial') }}" class="p-6 border-2 border-red-400 flex items-center gap-2 rounded-xl bg-red-200 hover:bg-red-400 transition-colors duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8">
