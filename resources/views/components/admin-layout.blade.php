                    ...
                    <div class="dash-menu mb-6 bg-gray-800">
                        <nav class="mt-6">
                            <ul class="space-y-6">
                                ...
                                <li>
                                    <button class="x-nav-link w-full text-left dash-dropdown cursor-pointer" aria-expanded="false">
                                        Videos
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="size-6">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"></path>
                                        </svg>
                                    </button>
                                    <div class="left-0 mt-2 bg-gray-600 rounded-xl p-2 hidden dash-drop-content">
                                ...
                                <li>
                                    ...
                                    <div class="left-0 mt-2 w-48 bg-gray-600 rounded-xl p-2 hidden dash-drop-content">
                                        <ul class="space-y-3 py-2">
